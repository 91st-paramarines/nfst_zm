...
private _rearPlaneLeftRx    = -formationSpacing * sin(formationAperture)  ;
private _rearPlaneLeftRy    =  formationSpacing * cos(formationAperture)  ;
private _rearPlaneRightRx   =  formationSpacing * sin(formationAperture)  ;
private _rearPlaneRightRy   =  formationSpacing * cos(formationAperture)  ;
...
for [{private _i = _even}, {_i < _escortSize + _even}, {_i = _i + 1}] do
{
    ...
    private _plane = "sab_p38" createVehicle _planeSpawn;
    ...
    ["true", "
    _plane = vehicle this;
    {deleteVehicleCrew _x} forEach crew _plane;
